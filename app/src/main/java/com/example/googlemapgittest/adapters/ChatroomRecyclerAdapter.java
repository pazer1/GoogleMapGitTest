...
public class ChatroomRecyclerAdapter extends RecyclerView.Adapter<ChatroomRecyclerAdapter.ViewHolder>{
    ...
    public ChatroomRecyclerAdapter(ArrayList<Chatroom> mChatrooms, ChatroomRecyclerClickListener mChatroomRecyclerClickListener) {
        this.mChatrooms = mChatrooms;
        this.mChatroomRecyclerClickListener = mChatroomRecyclerClickListener;
    }
    ...
    @Override
    public void onBindViewHolder(@NonNull ChatroomRecyclerAdapter.ViewHolder viewHolder, int i) {
        viewHolder.chatroomTitle.setText(mChatrooms.get(i).getTitle());
    }
    ...
    public class ViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener{
        ...
        public ViewHolder(@NonNull View itemView, ChatroomRecyclerClickListener clickListener) {
            super(itemView);
